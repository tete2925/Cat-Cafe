  ...
  <div class="login">
    ...
    <form method="POST" action="signup.php">
      ...
      <div class="mb-3">
        ...
        <input name="confirm_password" type="password" class="form-control" id="confirm_password" placeholder="Confirm your password">
        <span style="color:red;"><?php if(isset($confirm_password_error)){ echo $confirm_password_error; } ?></span>
      </div>
...
if (isset($_POST['save'])) {
  ...
  if (!isset($name_error) && !isset($email_error) && !isset($password_error) && !isset($confirm_password_error)) {
    echo "<span style='color:green;'>Signup successful!<br></span>";
